function Invoke-SecurityReview {
    ...
    $users = Get-MgBetaUser -All -Property "displayName,userPrincipalName,accountEnabled,createdDateTime,passwordPolicies,signInActivity,lastPasswordChangeDateTime"
    ...
    try {
        ...
        #Handle paging in Graph API results (some orgs will have >100 records)
        while ($uri) {
